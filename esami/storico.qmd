...
```{r}
ggplot(data  = filter(dataset, Appello %in% c("I", "II", "III")), aes(x = Appello, y = Esito, fill = Appello)) + geom_boxplot() + theme_light() + xlab("Anno Accademico") + theme(legend.position = "top") + scale_y_continuous(breaks = 18:31)
```
