...
**Nota**. Se possibile, si eviti di calcolare i valori $y_1,\dots,y_n$.
...
**Nota**: un camion può rifornire un negozio poi deve tornare al magazzino.
...
1. Si calcoli il primo ed il terzo quartile.
...
1. Calcolare il valore medio, mediano, il primo e il terzo quartile. Commentare i risultati.

1. A quale percentile corrisponde il valore $7$ del grado di soddisfazione? Spiegare il risultato.

1. I dipendenti risultano concordi nella valutazione della mensa? Sono contenti o scontenti? Cosa suggerireste ai responsabili della mensa?
...
1. Si svolga ora l'esercizio ipotizzando la relazione
$$
z = k + hx,
$$
...
1. Quanto valgono (approssimativamente) il primo ed il terzo quartile? 
