...
1. Si calcoli un'approssimazione della media e della mediana dopo un giorno di pioggia continuata.
...
$$y_i = 0.5 + (1 + 0.1) x_i, \qquad i=1,\dots,n.$$
...
1. Si calcoli il primo quartile ($\mathcal{Q}_{0.25}$), il terzo quartile ($\mathcal{Q}_{0.75}$) ed il quarto decile ($\mathcal{Q}_{0.4}$), seguendo la definizione data nelle [slides](../slides/sl_C.pdf).

1. Si confrontino questi indici di posizione con la funzione di ripartizione ottenuta nella prima esercitazione. I nuovi valori sembrano essere compatibili con i dati originari?
...
1. Si escluda il valore anomalo (-44) dall'analisi e si calcolino nuovamente media e mediana. Si commenti.
...
1. Calcolare la durata delle due frazioni di gara e quella complessiva.
